...
function incrementarPorUno(array) {
  ...
  // y devuelve el array
  // Tu código:
  let conjunto = array.map(elem => elem + 1);
  return conjunto;
}
...
function mesesDelAño(array) {
  ...
  // Tu código:
  let NewArray = array.filter(meses => meses === 'Enero' || meses === 'Marzo' || meses === 'Noviembre');
